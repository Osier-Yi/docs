...
- [**Hooking Functions**](/v1/building-blocks/hooking-functions) — Detailed usage of agent hooks, including Human-in-the-Loop patterns
- [**Orchestration**](/v1/building-blocks/orchestration) — In-depth guide to routing strategies, MsgHub, and Orchestrator-Workers patterns
