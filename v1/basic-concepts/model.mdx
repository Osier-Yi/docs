...
<Tip>
For detailed usage examples and a full provider reference table mapping each model class to its corresponding formatter, see [Models](/v1/building-blocks/models).
</Tip>
