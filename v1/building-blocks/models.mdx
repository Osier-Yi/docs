...
<Info>
For core concepts and design principles, see [Model](/v1/basic-concepts/model). For details on `Msg` and content blocks, see [Msg](/v1/basic-concepts/msg).
</Info>
...
<Tip>
Use the `Toolkit` class to auto-generate JSON schemas from Python functions with docstrings. See [Tool](/v1/basic-concepts/tool) for details.
</Tip>
