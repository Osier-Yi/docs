...
> For conceptual background, see [Context and Memory](/v1/basic-concepts/context-and-memory).
...
<CardGroup cols={2}>
  <Card title="Agent" icon="user-robot" href="/v1/basic-concepts/agent">
    Understand the agent's core methods and the ReAct paradigm.
  </Card>
  <Card title="Tool" icon="wrench" href="/v1/basic-concepts/tool">
