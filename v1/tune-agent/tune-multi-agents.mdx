...
Add the `logger` parameter to your workflow function (see [Agent Reinforcement Learning — Runtime Monitoring](/v1/tune-agent/model-weights-tuning#runtime-monitoring)) to debug multi-agent interactions during tuning.
</Accordion>
