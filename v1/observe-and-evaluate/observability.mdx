...
For programmatic access to usage after a model call, use the `usage` field on the [ChatResponse](/v1/building-blocks/models) returned by the model.
...
For evaluation of agent behavior and benchmarks, see [Evaluation](/v1/observe-and-evaluate/evaluation).
