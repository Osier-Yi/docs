...
This pattern is the foundation of the [human-in-the-loop](/v2/building-blocks/agent) workflow, where certain actions require human approval or manual execution.
