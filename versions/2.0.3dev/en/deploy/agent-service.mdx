...
|------------|-------------|
| Agent teams | A leader agent spawns worker agents and coordinates them through built-in team tools; see the [Agent Team](/versions/2.0.3dev/en/deploy/agent-team) chapter. |
...
<CardGroup cols={2}>
  ...
  <Card title="Message & Event" icon="envelope" href="/versions/2.0.3dev/en/building-blocks/message-and-event">
