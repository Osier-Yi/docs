...
This page tracks notable changes across AgentScope 2.x releases. Each version is organized into three sections — **Added**, **Changed**, and **Fixed** — and entries inside each section are grouped by module (e.g., *Model*, *Tool*, *WebUI*) so you can scan the changes that affect the area you care about.
...
- **Task tools** added: `TaskCreate`, `TaskGet`, `TaskList`, and `TaskUpdate` (see the [Plan](/versions/2.0.3dev/en/building-blocks/plan) page). ([#1549](https://github.com/agentscope-ai/agentscope/pull/1549))
