...
<CardGroup cols={2}>
  <Card title="Permission System" href="/versions/2.0.4dev/en/building-blocks/permission-system">
    Control which tools the agent can call and under what conditions.
  </Card>
  <Card title="Middleware" href="/versions/2.0.4dev/en/building-blocks/middleware">
