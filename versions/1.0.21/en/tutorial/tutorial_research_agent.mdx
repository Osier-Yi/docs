...
- [**Context and Memory**](/versions/1.0.21/en/building-blocks/context-and-memory) — Complete guide to short-term and long-term memory
- [**Tool Capabilities**](/versions/1.0.21/en/building-blocks/tool-capabilities) — Complete guide to tools and function calling
- [**Agent**](/versions/1.0.21/en/basic-concepts/agent) — Agent customization and advanced features
