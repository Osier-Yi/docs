...
<Tip>
For embedding models and how to configure them, see the [Embedding Model chapter](/versions/2.0.5dev/en/building-blocks/model); for the service version of RAG (with an HTTP service, file hosting, and distributed indexing), see [RAG Service](/versions/2.0.5dev/en/deploy/rag).
</Tip>
...
See the [Embedding Model chapter](/versions/2.0.5dev/en/building-blocks/model).
...
<CardGroup cols={1}>
  ...
  <Card title="Embedding Model" icon="cube" href="/versions/2.0.5dev/en/building-blocks/model" cta="View model list" arrow>
