...
<CardGroup cols={1}>
	<Card title="ReAct Agent" icon="robot" href="/versions/2.0.5dev/en/building-blocks/agent" cta="Get Started">
	...
	<Card title="Toolkit" icon="toolbox" href="/versions/2.0.5dev/en/building-blocks/tool" cta="Learn about toolkit">
		Agent self-managed tool system with Python functions, MCP and skills integration.
	</Card>
	<Card title="Context" icon="memory" href="/versions/2.0.5dev/en/building-blocks/context" cta="View context">
	...
	<Card title="Sandbox Isolation" icon="codepen" href="/versions/2.0.5dev/en/building-blocks/workspace" cta="Learn about sandbox">
